...
@section('keywords', '飞越彩虹, 新西兰, 奥克兰, 奥克兰大学, 上海交通大学, New Zealand, Auckland, University of Auckland, Shanghai Jiao Tong University, Computer Science, Information System, Zhen Chen')

@section('title', 'Zhen Chen | 飞越彩虹')

@section('canonical', 'https://zhen-chen.com/')
